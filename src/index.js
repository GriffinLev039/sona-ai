...
//Make switch/case statement instead of long if-else
...
client.on('messageCreate', async message => {
    ...
    } else if (message.content.toLowerCase().trim().startsWith('!addquote')) {
        let sonaStr = message.content.replace('!addQuote', '').replaceAll("'", "").replaceAll('"', '').replaceAll('/', '');
        writer.write(sonaStr);
    } else if (message.content.toLowerCase().trim().startsWith('!listquotes')) {
